...
class SphereNoisePage extends StatefulWidget {
  const SphereNoisePage({Key? key}) : super(key: key);
  static const String sName = "SphereNoise";
  @override
  State<SphereNoisePage> createState() => _SphereNoisePageState();
}

class _SphereNoisePageState extends State<SphereNoisePage>
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: CustomPaint(
                        painter: SphereNoisePainter(progress: sides),
                      ),
                    ),
                    const SizedBox(
                      height: 200,
